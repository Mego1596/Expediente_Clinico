                            ...
                            if($form["uretral"]->getData() != ""){
                                if($form["urotelio"]->getData() != ""){
                                    if($form["renal"]->getData() != ""){
                                        if($form["leucocitos"]->getData() != ""){
                                            if($form["piocitos"]->getData() != ""){
                                                if($form["eritrocitos"]->getData() != ""){
                                                    if($form["bacteria"]->getData() != ""){
                                                        if($form["parasitos"]->getData() != ""){
                                                            if($form["funguria"]->getData() != ""){
                                                                if($form["filamentoDeMucina"]->getData() != ""){
                                                                    if($form["proteinaUromocoide"]->getData() != ""){
                                                                        if($form["cilindros"]->getData() != ""){
                                                                            ...
                                                                            $this->addFlash('fail', 'Error, Cilindros no puede ir vacio');
                                                                        ...
                                                                        $this->addFlash('fail', 'Error, Proteina Uromucoide no puede ir vacio');
                                                                        return $this->render('examen_orina_microscopico/new.html.twig', [
                                                                            'examen_orina_microscopico' => $examenOrinaMicroscopico,
                                                                            'examen_solicitado' => $examen_solicitado,
                                                                            'editar'            => $editar,
                                                                    ...
                                                                    $this->addFlash('fail', 'Error, Filamento de Mucina no puede ir vacio');
                                                                    return $this->render('examen_orina_microscopico/new.html.twig', [
                                                                        'examen_orina_microscopico' => $examenOrinaMicroscopico,
                                                                        'examen_solicitado' => $examen_solicitado,
                                                                        'editar'            => $editar,
                                                                ...
                                                                $this->addFlash('fail', 'Error, Funguria no puede ir vacio');
                                                                return $this->render('examen_orina_microscopico/new.html.twig', [
                                                                    'examen_orina_microscopico' => $examenOrinaMicroscopico,
                                                                    'examen_solicitado' => $examen_solicitado,
                                                                    'editar'            => $editar,
                                                           ...
                                                           $this->addFlash('fail', 'Error, Parasitos no puede ir vacio');
                                                            return $this->render('examen_orina_microscopico/new.html.twig', [
                                                                'examen_orina_microscopico' => $examenOrinaMicroscopico,
                                                                'examen_solicitado' => $examen_solicitado,
                                                                'editar'            => $editar,
                                                        ...
                                                        $this->addFlash('fail', 'Error, Bacterias no puede ir vacio');
                                                        return $this->render('examen_orina_microscopico/new.html.twig', [
                                                            'examen_orina_microscopico' => $examenOrinaMicroscopico,
                                                            'examen_solicitado' => $examen_solicitado,
                                                            'editar'            => $editar,
                                                    ...
                                                    $this->addFlash('fail', 'Error, eritrocitos no puede ir vacio');
                                                    return $this->render('examen_orina_microscopico/new.html.twig', [
                                                        'examen_orina_microscopico' => $examenOrinaMicroscopico,
                                                        'examen_solicitado' => $examen_solicitado,
                                                        'editar'            => $editar,
                                                ...
                                                $this->addFlash('fail', 'Error, Piocitos no puede ir vacio');
                                                return $this->render('examen_orina_microscopico/new.html.twig', [
                                                    'examen_orina_microscopico' => $examenOrinaMicroscopico,
                                                    'examen_solicitado' => $examen_solicitado,
                                                    'editar'            => $editar,
                                        ...
                                        $this->addFlash('fail', 'Error, Renal no puede ir vacio');
                                        return $this->render('examen_orina_microscopico/new.html.twig', [
                                            'examen_orina_microscopico' => $examenOrinaMicroscopico,
                                            'examen_solicitado' => $examen_solicitado,
                                            'editar'            => $editar,
                                    ...
                                    $this->addFlash('fail', 'Error, Urotelio no puede ir vacio');
                                    return $this->render('examen_orina_microscopico/new.html.twig', [
                                        'examen_orina_microscopico' => $examenOrinaMicroscopico,
                                        'examen_solicitado' => $examen_solicitado,
                                        'editar'            => $editar,
                                ...
                                $this->addFlash('fail', 'Error, Uretral no puede ir vacio');
                                return $this->render('examen_orina_microscopico/new.html.twig', [
                                    'examen_orina_microscopico' => $examenOrinaMicroscopico,
                                    'examen_solicitado' => $examen_solicitado,
                                    'editar'            => $editar,
