 ...
 */
final class Version20190501032108 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, rol_id INT NOT NULL, hospital_id INT NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D6494BAB96C (rol_id), INDEX IDX_8D93D64963DBB69 (hospital_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cita (id INT AUTO_INCREMENT NOT NULL, usuario_id INT NOT NULL, expediente_id INT NOT NULL, fecha_reservacion DATETIME NOT NULL, consulta_por LONGTEXT NOT NULL, creado_en DATETIME DEFAULT NULL, actualizado_en DATETIME DEFAULT NULL, INDEX IDX_3E379A62DB38439E (usuario_id), INDEX IDX_3E379A624BF37E4E (expediente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cita_examen (id INT AUTO_INCREMENT NOT NULL, cita_id INT NOT NULL, fecha_examen DATETIME NOT NULL, creado_en DATETIME DEFAULT NULL, actualizado_en DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_B5EEB821E011DDF (cita_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE diagnostico (id INT AUTO_INCREMENT NOT NULL, descripcion LONGTEXT NOT NULL, creado_en DATETIME DEFAULT NULL, actualizado_en DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE examen_heces_quimico (id_examen_heces_quimico INT AUTO_INCREMENT NOT NULL, examen_solicitado_id INT NOT NULL, ph DOUBLE PRECISION NOT NULL, azucares_reductores LONGTEXT NOT NULL, sangre_oculta LONGTEXT NOT NULL, creado_en DATETIME DEFAULT NULL, actualizado_en DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_49A805AC43CA3347 (examen_solicitado_id), PRIMARY KEY(id_examen_heces_quimico)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE examen_hematologico (id INT AUTO_INCREMENT NOT NULL, examen_solicitado_id INT NOT NULL, tipo_serie LONGTEXT NOT NULL, unidad LONGTEXT NOT NULL, valor_referencia LONGTEXT NOT NULL, creado_en DATETIME DEFAULT NULL, actualizado_en DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_AE3CB97343CA3347 (examen_solicitado_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE habitacion (id INT AUTO_INCREMENT NOT NULL, sala_id INT NOT NULL, tipo_habitacion_id INT NOT NULL, numero_habitacion INT NOT NULL, creado_en DATETIME DEFAULT NULL, actualizado_en DATETIME DEFAULT NULL, INDEX IDX_F45995BAC51CDF3F (sala_id), INDEX IDX_F45995BAB0BA7A53 (tipo_habitacion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE usuario_especialidad (id INT AUTO_INCREMENT NOT NULL, especialidad_id INT NOT NULL, usuario_id INT NOT NULL, INDEX IDX_A688E12C16A490EC (especialidad_id), INDEX IDX_A688E12CDB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6494BAB96C FOREIGN KEY (rol_id) REFERENCES rol (id)');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D64963DBB69 FOREIGN KEY (hospital_id) REFERENCES clinica (id)');
        ...
        $this->addSql('ALTER TABLE cita_examen ADD CONSTRAINT FK_B5EEB821E011DDF FOREIGN KEY (cita_id) REFERENCES cita (id)');
        ...
        $this->addSql('ALTER TABLE examen_solicitado ADD CONSTRAINT FK_779218FBB5A95C01 FOREIGN KEY (cita_examen_id) REFERENCES cita_examen (id)');
        ...
        $this->addSql('ALTER TABLE sala ADD CONSTRAINT FK_E226041C1E2F769E FOREIGN KEY (id_hospital_id) REFERENCES clinica (id)');
        $this->addSql('ALTER TABLE signo_vital ADD CONSTRAINT FK_75668911E011DDF FOREIGN KEY (cita_id) REFERENCES cita (id)');
        $this->addSql('ALTER TABLE usuario_especialidad ADD CONSTRAINT FK_A688E12C16A490EC FOREIGN KEY (especialidad_id) REFERENCES especialidad (id)');
        $this->addSql('ALTER TABLE usuario_especialidad ADD CONSTRAINT FK_A688E12CDB38439E FOREIGN KEY (usuario_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE user ADD nombres VARCHAR(255) NOT NULL, ADD apellidos VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE usuario_especialidad DROP FOREIGN KEY FK_A688E12CDB38439E');
        $this->addSql('ALTER TABLE ingresado DROP FOREIGN KEY FK_6682CB4BFEEC2797');
        $this->addSql('ALTER TABLE cita_examen DROP FOREIGN KEY FK_B5EEB821E011DDF');
        ...
        $this->addSql('ALTER TABLE examen_solicitado DROP FOREIGN KEY FK_779218FBB5A95C01');
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D64963DBB69');
        $this->addSql('ALTER TABLE sala DROP FOREIGN KEY FK_E226041C1E2F769E');
        $this->addSql('ALTER TABLE historia_medica DROP FOREIGN KEY FK_328E741C7A94BA1A');
        $this->addSql('ALTER TABLE plan_tratamiento DROP FOREIGN KEY FK_951D78177A94BA1A');
        $this->addSql('ALTER TABLE usuario_especialidad DROP FOREIGN KEY FK_A688E12C16A490EC');
        ...
        $this->addSql('ALTER TABLE permisos_por_rol DROP FOREIGN KEY FK_43E7CADA4BAB96C');
        ...
        $this->addSql('DROP TABLE cita_examen');
        ...
        $this->addSql('DROP TABLE permisos_por_rol');
        ...
        $this->addSql('DROP TABLE usuario_especialidad');
    }
}
